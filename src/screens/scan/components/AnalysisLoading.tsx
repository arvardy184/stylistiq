  ...
  return (
    <View className="flex-1 justify-center items-center bg-white p-8">
      <View className="flex-row mb-8">
        <Animated.View style={animatedIconStyle(0)}>
          <Ionicons name="shirt-outline" size={48} color="#8B5CF6" />
        </Animated.View>
        <Animated.View style={animatedIconStyle(1)}>
          <Ionicons name="scan-outline" size={48} color="#EC4899" />
        </Animated.View>
        <Animated.View style={animatedIconStyle(2)}>
      ...
      <Text className="text-gray-600 text-center">
        Please wait a moment while we identify {imageCount} {imageCount > 1 ? 'items' : 'item'}.
